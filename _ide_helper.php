 ...
 * Generated for Laravel 5.5.20 on 2017-12-08.
 *
...
namespace ShawnSandy\Orangebox {
    ...
    class OrangeboxFacade {
        ...
        {
            return \ShawnSandy\Orangebox\Orangebox::routes();
        }
...
namespace ShawnSandy\Jarvis {
    ...
    class JarvisFacade {
        ...
        public static function routes()
        {
            \ShawnSandy\Jarvis\Jarvis::routes();
        }
         ...
         * @static
         */
        public static function install_routes()
        {
            \ShawnSandy\Jarvis\Jarvis::install_routes();
        }
         ...
         * @static
         */
        public static function generator_routes()
        {
            return \ShawnSandy\Jarvis\Jarvis::generator_routes();
        }
         ...
         * @static
         */
        public static function views($blade, $theme = null)
        {
            return \ShawnSandy\Jarvis\Jarvis::views($blade, $theme);
        }
         ...
         * @static
         */
        public static function view($blade, $theme = null)
        {
            return \ShawnSandy\Jarvis\Jarvis::view($blade, $theme);
        }

        /**
         * Set the theme
         *
         * @param \ShawnSandy\Jarvis\[type] $theme
         * @return void
         * @static
         */
        public static function theme($theme)
        {
            \ShawnSandy\Jarvis\Jarvis::theme($theme);
        }
         ...
         * @static
         */
        public static function url($route_url)
        {
            return \ShawnSandy\Jarvis\Jarvis::url($route_url);
        }
         ...
         * @static
         */
        public static function md($file)
        {
            return \ShawnSandy\Jarvis\Jarvis::md($file);
        }
         ...
         * @static
         */
        public static function env_to_array($file = null)
        {
            return \ShawnSandy\Jarvis\Jarvis::env_to_array($file);
        }
...
namespace ShawnSandy\DashAuth {
    ...
    class DashAuthFacade {
        ...
        public static function routes()
        {
            return \ShawnSandy\DashAuth\DashAuth::routes();
        }
        ...
        {
            return \ShawnSandy\DashAuth\DashAuth::roles();
        }
...
namespace ShawnSandy\ImgFly\Classes {
    ...
    class ImgflyFacade {
        ...
        public static function routes()
        {
            return \ShawnSandy\ImgFly\Classes\ImgFly::routes();
        }
        ...
        {
            \ShawnSandy\ImgFly\Classes\ImgFly::imgFly($image_str);
        }
        ...
        {
            \ShawnSandy\ImgFly\Classes\ImgFly::img($image_str);
        }
        ...
        {
            \ShawnSandy\ImgFly\Classes\ImgFly::imgPublic($image_str, $dir);
        }
        ...
        {
            return \ShawnSandy\ImgFly\Classes\ImgFly::imgPreset($img, $preset, $callBackMethod);
        }
...
namespace ShawnSandy\Backstory {
    ...
    class BackstoryFacade {
        ...
        public static function routes()
        {
            return \ShawnSandy\Backstory\Backstory::routes();
        }
         ...
         * @static
         */
        public static function formClass($class = array())
        {
            return \ShawnSandy\Backstory\Backstory::formClass($class);
        }
         ...
         * @static
         */
        public static function label($name, $label_for, $class = 'label')
        {
            return \ShawnSandy\Backstory\Backstory::label($name, $label_for, $class);
        }
         ...
         * @static
         */
        public static function input($name, $class = array())
        {
            return \ShawnSandy\Backstory\Backstory::input($name, $class);
        }
         ...
         * @static
         */
        public static function email($name, $class = array())
        {
            return \ShawnSandy\Backstory\Backstory::email($name, $class);
        }
         ...
         * @static
         */
        public static function textarea($name, $value = null, $class = array())
        {
            return \ShawnSandy\Backstory\Backstory::textarea($name, $value, $class);
        }
        ...
        {
            return \ShawnSandy\Backstory\Backstory::checkbox($name, $checked, $value);
        }
         ...
         * @static
         */
        public static function title($placeholder = 'Enter a catchy title for your story', $size = array())
        {
            return \ShawnSandy\Backstory\Backstory::title($placeholder, $size);
        }
         ...
         * @static
         */
        public static function introduction($placeholder = 'Pitch (introduce) the story', $class = array())
        {
            return \ShawnSandy\Backstory\Backstory::introduction($placeholder, $class);
        }
         ...
         * @static
         */
        public static function content($placeholder = 'Lets write the next block buster', $class = array())
        {
            return \ShawnSandy\Backstory\Backstory::content($placeholder, $class);
        }
         ...
         * @static
         */
        public static function featured($value = null)
        {
            \ShawnSandy\Backstory\Backstory::featured($value);
        }
        ...
        {
            return \ShawnSandy\Backstory\Backstory::type($value);
        }
        ...
        {
            \ShawnSandy\Backstory\Backstory::status($value);
        }
         ...
         * @static
         */
        public static function newForm($model = null)
        {
            \ShawnSandy\Backstory\Backstory::newForm($model);
        }
         ...
         * @static
         */
        public static function formClose($close_model = false)
        {
            \ShawnSandy\Backstory\Backstory::formClose($close_model);
        }
         ...
         * @static
         */
        public static function category($categories = array(), $value = null)
        {
            \ShawnSandy\Backstory\Backstory::category($categories, $value);
        }
         ...
         * @static
         */
        public static function latestStories($limit = 20)
        {
            \ShawnSandy\Backstory\Backstory::latestStories($limit);
        }
         ...
         * @static
         */
        public static function getImgs($disk = 'images', $directory = 'img')
        {
            return \ShawnSandy\Backstory\Backstory::getImgs($disk, $directory);
        }
         ...
         * @static
         */
        public static function imgFly($image, $size = 'small')
        {
            return \ShawnSandy\Backstory\Backstory::imgFly($image, $size);
        }
...
namespace Collective\Remote {
    ...
    class RemoteFacade {
        ...
        {
            return \Collective\Remote\RemoteManager::connect($config);
        }
...
namespace  {
    ...
    class Orangebox extends \ShawnSandy\Orangebox\OrangeboxFacade {}

    class Jarvis extends \ShawnSandy\Jarvis\JarvisFacade {}

    class Dashauth extends \ShawnSandy\DashAuth\DashAuthFacade {}

    class Imgfly extends \ShawnSandy\ImgFly\Classes\ImgflyFacade {}

    class Backstory extends \ShawnSandy\Backstory\BackstoryFacade {}
